...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/templates/watch/assets/css/video.css'/>">
    <link rel="stylesheet" href="<c:url value='/templates/watch/assets/css/video_responsive.css'/>">
...
<div class="container-video">
        ...
        <div class="row video-product">
            <div class="col-8 video_container-left">
                <div class="video_main">
                    <iframe width="100%" height="512"
                            src="<c:url value='https://www.youtube.com/embed/WRfFhZqc5gk?autoplay=1'/>"
                    ...
                    <div class="video_channel">
                        <ul class="video_channel-main">
                            <li class="video_channel-item">
                                <img src="<c:url value='/templates/common/assets/img/f8-myfavourite.jpg'/>" alt=""
                                     class="video_channel-img">
                            </li>
                    ...
                    <div class="video_channel-desc">
                        <div class="video_channel-desc-main">
                            <p>Bạn muốn học lập trình hiệu quả hơn không?<br>
                                Hãy học tại trang web <a href=""
                                                         style="text-decoration:none">https://fullstack.edu.vn</a> thay
                                vì Youtube. Lý do tại sao mời bạn bấm vào đây: <a href="" style="text-decoration:none">https://www.youtube.com/watch?v=f5hbm...</a>
                            </p>
                        </div>
                        ...
                        <div class="video_channel-sub-desc">
                            ...
                            Công cụ dịch Tiếng Anh: <a href=""
                                                       style='text-decoration: none'>http://bit.ly/2Wsuhet</a><br>
                            Công cụ đo đạc giao diện web: <a href="" style='text-decoration: none;'>
                            http://bit.ly/3muevdD</a><br>
                            Công cụ viết CV xin việc chuyên nghiệp: <a href="" style='text-decoration: none;'>
                            https://mycv.vn</a><br>
                            ...
                            Thêm màu sắc cho các cặp ngoặc: Bracket Pair Colorizer (<a href=""
                                                                                       style="text-decoration: none">http://bit.ly/37wgXfC</a>)<br>
                            Icon theme: Material Icon Theme (<a href="" style="text-decoration: none">http://bit.ly/37ukU4b</a>)<br>
                            Hiển thị thông tin Git (commit, author, ...): Gitlens (<a href=""
                                                                                      style="text-decoration: none">http://bit.ly/3gYlaf9</a>)<br>
                            ...
                            Xem thêm tại: <a href=""
                                             style="text-decoration: none">https://fullstack.edu.vn/courses</a><br>
                            ...
                            Facebook cá nhân: <a href=""
                                                 style="text-decoration: none">https://facebook.com/sondnmc</a><br>
                    ...
                    <div class="video_comment-user">
                        <div class="video_comment-user-img">
                            <img src="<c:url value="/templates/common/assets/img/AE_LONG.jpg"/>"
                                 alt="Avatar Channel Comment" class="video_comment-user-img-main">
                        </div>

                        <div class="video_comment-user-input">
                        </div>
                        <label for="#"></label><input type="text" name="" id="#" class="video-input"
                    ...
                    <div class="video-list-comments">
                        <div class="video_comment-user-response">
                            <img src="<c:url value="/templates/common/assets/img/f8-myfavourite.jpg"/>"
                                 alt="Avatar Channel Comment" class="video_comment-user-response-img">
                            <div class="video_comment-user-response-main">
                                ...
                                <div class="box-response-one">
                                    <div class="box-response-img">
                                        <img src="<c:url value="/templates/common/assets/img/AE_LONG.jpg"/>"
                                             alt="Avatar Channel Comment" class="box-response-img-main">
                                    </div>

                                    <div class="box-response-input">
                                    </div>
                                    <label>
                                        <input type="text" name="" class="box-response-input-main-one"
                                ...
                                <div class="video_comment-list-down">
                                    ...
                                    <div class="video_comment-list-down-main">
                                        <div class="video_comment-user-response sub-user-response">
                                            <img src="<c:url value="/templates/common/assets/img/AE_LONG.jpg"/>"
                                                 alt="Avatar Channel Comment" class="sub-user-response-img">
                                            <div class="video_comment-user-response-main">
                                                <div class="video_comment-user-response-main-title">
                                                    <div class="video_comment-user-response-main-title-name">
                                                            <span>Long HD
                            ...
                            <div class="video_comment-user-response">
                                ...
                                <div class="video_comment-user-response-main">
                                    ...
                                    <div class="box-response-two">
                                        ...
                                        <label>
                                            <input type="text" name="" class="box-response-input-main-two"
                                                   placeholder="Phản hồi công khai...">
                                        </label>
                                ...
                                <div class="video_comment-user-response">
                                    ...
                                    <div class="video_comment-user-response-main">
                                        ...
                                        <div class="box-response-three">
                                            ...
                                            <label>
                                                <input type="text" name="" class="box-response-input-main-three"
                                                       placeholder="Phản hồi công khai...">
                                            </label>
                                    ...
                                    <div class="video_comment-user-response">
                                        ...
                                        <div class="video_comment-user-response-main">
                                            ...
                                            <div class="box-response-four">
                                                ...
                                                <label>
                                                    <input type="text" name="" class="box-response-input-main-four"
                                                           placeholder="Phản hồi công khai...">
                                                </label>
                                        ...
                                        <div class="video_comment-user-response">
                                            ...
                                            <div class="video_comment-user-response-main">
                                                ...
                                                <div class="box-response-five">
                                                    ...
                                                    <label>
                                                        <input type="text" name="" class="box-response-input-main-five"
                                                               placeholder="Phản hồi công khai...">
                                                    </label>
            ...
            <div class="col-4 video_container-right">
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video2.jpg"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                        ...
                        <div class="product_video_content">
                            <div class="product_video-img-user">
                                <img src="<c:url value="/templates/common/assets/img/f8-myfavourite.jpg"/>"
                                     alt="Avatar Channel" style="display: none;">
                            </div>

                            <div class="product_video-description">
                                <div class="product_video-title-product">
                                    <h4>Lần trở lại này F8 sẽ làm gì cho các bạn? Học lập trình để đi làm tại F8
                                        nào!</h4>
                                </div>
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video3.jpg"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video4.png"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                        ...
                        <div class="product_video_content">
                            ...
                            <div class="product_video-description">
                                <div class="product_video-title-product">
                                    <h4>Sinh viên IT đi thực tập cần biết những gì? | Đi thực tập cần chuẩn bị những gì?
                                        | Thực tập IT</h4>
                                </div>
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video5.png"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                        ...
                        <div class="product_video_content">
                            <div class="product_video-img-user">
                                <img src="<c:url value="/templates/common/assets/img/tuan-can.jpg"/>"
                                     alt="Avatar Channel" style="display: none;">
                            </div>
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video6.jpg"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video7.png"/>" alt="Avatar Video"
                                 class="product_video-img-main">
                        ...
                        <div class="product_video_content">
                            <div class="product_video-img-user">
                                <img src="<c:url value="/templates/common/assets/img/A_navu.jpg"/>" alt="Avatar Channel"
                                     style="display: none;">
                            </div>
                ...
                <div class="product_video">
                    <a href="#" class="product_video-link">
                        <div class="product_video-img">
                            <img src="<c:url value="/templates/common/assets/img/video8.jpg"/>" alt="Avatar Video"
                                 class="product_video-img-main">
    ...
    <div class="video_box-share">
        <div class="video-box-share-content">
            ...
            <div class="video-box-share-input">
                <label>
                    <input type="checkbox" name="" class="share-input">
                </label>
    ...
    <div class="video_box-save">
            ...
            <ul class="video_box-list-save">
                <li class="video_box-item-save">
                    <div class="video_box-item-save-left">
                        <label>
                            <input type="checkbox" name="" class="video_box-save-input">
                        </label>
            ...
            <ul class="video_box-new-list-down">
                <li class="video_box-new-item-down">
                    <div class="video_box-new-input">
                        <label for=""
                               style="font-size: 1.4rem; color: var(--black-color); font-family: 'roboto','sans-serif';">Tên</label>
                        <label>
                            <input type="text" name="" placeholder="Nhập tên danh sách phát..."
                                   class="video_box-new-input-main">
                        </label>
        ...
        <script src="<c:url value="/templates/watch/assets/js/video.js"/>" type=""></script>
    </div>
</div>
</body>
</html>