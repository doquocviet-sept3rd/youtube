...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/templates/header/assets/css/responsive.css'/>" type="text/css"
          media="all">
    <link rel="stylesheet" href="<c:url value='/templates/common/assets/fonts/Fontawesome_pro_v6/css/all.css'/>"
          type="text/css" media="all">
    <link rel="shortcut icon" type="image/png"
          href="<c:url value="/templates/common/assets/imgs/youtube_favicon.png"/>"/>
    <dec:head/>
</head>
<body>
