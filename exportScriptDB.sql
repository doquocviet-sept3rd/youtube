...
create table user (id bigint not null auto_increment, avatarChannelUrl varchar(4096), avatarUrl varchar(4096) not null, coverChannelUrl varchar(4096), created_by bigint, created_on datetime(6), email varchar(255) not null, modified_by bigint, modified_on datetime(6), name nvarchar(255) not null, nameChannel nvarchar(255), password varchar(255) not null, subscribe bigint, primary key (id)) engine=InnoDB;
...
create table video (id bigint not null auto_increment, avatarUrl varchar(255), category_id bigint not null, content varchar(4096), created_by bigint, created_on datetime(6), dislikes bigint not null, hashtag varchar(255), likes bigint not null, modified_by bigint, modified_on datetime(6), name varchar(255) not null, postingTime datetime(6) not null, src varchar(4096) not null, timeLimit double precision not null, user_id bigint not null, views bigint not null, primary key (id)) engine=InnoDB;
